...
class CatchGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        if self.current_screen == "start":
            ...
            arcade.draw_text("Use LEFT and RIGHT arrows to move", SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 90, arcade.color.GRAY, 16, anchor_x="center")
            ...
            if self.slow_motion_active:
                arcade.draw_text("SLOW MOTION!", SCREEN_WIDTH // 2, SCREEN_HEIGHT - 30, arcade.color.LIGHT_BLUE, 20, anchor_x="center")
